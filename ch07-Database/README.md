...
Use CGI and the python file should be named as "main.py" and be put in a folder named as "cgi-bin"
(Error occured when another python file name used).<br>
```zsh
➜ pwd
...
::1 - - [05/Mar/2020 14:32:13] "GET / HTTP/1.1" 200 -
```
Open 
```url
